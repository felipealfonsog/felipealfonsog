...
<sub>Note that it's best to open links in a new tab for a seamless experience. Hover over the link, right-click, and choose "Open Link in New Tab" since Github doesn't support markdown links with a blank target property.</sub>
<details>
