...
-->
Throughout my journey, I've taken on roles ranging from Head of Engineering** to **Software Engineer, even diving into research on advanced algorithms. I've had the privilege of working in different parts of the world, including Europe, the USA, and my home turf in South America - Chile. As a *Computer Science engineer*, I've been lucky to contribute to a variety of projects.

Right now, I'm involved with [Nymex](https://github.com/NymexData), a personal project focused on open-source endeavors. Our team is a mix of talented folks from around the world, including experienced pros and those just starting out. Together, we're all about pushing technology boundaries while also providing consulting services that span the globe. We're based in Santiago Metropolitan, Chile, which we proudly call home.
