...
I still keep my 90s-era [Perl](https://www.perl.org/) book (~1200 pages) — a reminder of long nights with coffee, dim light, and room-heating machines with painfully bad [CRT](https://en.wikipedia.org/wiki/Cathode-ray_tube) screens, when computers were heavy towers — not millimeters-thin devices. That was my era: experimenting with network cables in my bedroom, running multiple rigs, giving old hardware a second life with [Mandrake Linux](https://en.wikipedia.org/wiki/Mandrake_Linux). Later, I carried that obsession into engineering school.
