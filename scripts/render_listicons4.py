...
import config_listicons4 as cfg
...
def load_links_json() -> list[dict]:
    ...
    if not isinstance(data, list):
        raise ValueError("list-icons4-links.json must contain a JSON array.")
...
def main() -> int:
    ...
    if updated != original:
        ...
        print("README updated for List-icons4.")
    else:
        print("No changes needed for List-icons4.")
